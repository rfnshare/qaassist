...
- Step 0029 team analytics must summarize only provided current-session evidence. Missing sections must be reported as warnings instead of guessed, and analytics must not be presented as complete board history.
